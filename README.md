<p align="center">
  <img src="https://img.shields.io/badge/갈래말래-Travel%20Community-0284C7?style=for-the-badge&logo=compass&logoColor=white" alt="갈래말래"/>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/MyBatis-3.0.5-000000?style=flat-square&logo=apache&logoColor=white" alt="MyBatis"/>
  <img src="https://img.shields.io/badge/JSP%20%2F%20JSTL-Jakarta-E76F00?style=flat-square&logo=html5&logoColor=white" alt="JSP"/>
  <img src="https://img.shields.io/badge/MySQL-8.0.46-4479A1?style=flat-square&logo=mysql&logoColor=white" alt="MySQL"/>
...
<p align="center">
  <img src="https://img.shields.io/badge/Team-가고싶긴해-0284C7?style=flat-square" alt="Team 가고싶긴해"/>
  <img src="https://img.shields.io/badge/Roles-User%20%7C%20Business%20%7C%20Admin-0D9488?style=flat-square" alt="Roles"/>
  <img src="https://img.shields.io/badge/Batch-Incremental%20Sync-10B981?style=flat-square" alt="Batch"/>
  <img src="https://img.shields.io/badge/NLP-Komoran%20%2B%20KNU-8B5CF6?style=flat-square" alt="NLP"/>
</p>
...
<p align="left">
  <img src="https://img.shields.io/badge/Platform-Travel%20Community-0284C7?style=flat-square" alt="Platform"/>
  <img src="https://img.shields.io/badge/Data-한국관광공사%20TourAPI%202.0-059669?style=flat-square" alt="TourAPI"/>
  <img src="https://img.shields.io/badge/Security-BCrypt%20%2B%20Idempotency-DC2626?style=flat-square" alt="Security"/>
  <img src="https://img.shields.io/badge/Payment-KakaoPay%20%2B%20TossPayments-0064FF?style=flat-square" alt="Payments"/>
  <img src="https://img.shields.io/badge/Batch%20Engine-Queue%20Selecting%20%2B%20Jitter-D97706?style=flat-square" alt="Queue Selecting"/>
</p>

### 기술 스택 배지

<p align="left">
  <img src="https://img.shields.io/badge/Backend-Spring%20Boot%203%20%7C%20Java%2017-6DB33F?style=flat-square&logo=springboot&logoColor=white" alt="Backend"/>
  <img src="https://img.shields.io/badge/Persistence-MyBatis%203.0.5-000000?style=flat-square&logo=apache&logoColor=white" alt="MyBatis"/>
  <img src="https://img.shields.io/badge/Frontend-JSP%20%2F%20JSTL%20%2B%20JavaScript%20(ES6+)-E76F00?style=flat-square&logo=html5&logoColor=white" alt="Frontend"/>
  <img src="https://img.shields.io/badge/Database-MySQL%208.0.46-4479A1?style=flat-square&logo=mysql&logoColor=white" alt="MySQL"/>
  <img src="https://img.shields.io/badge/Resilience-Resilience4j%20(RateLimiter%2C%20Retry)-FF4F00?style=flat-square" alt="Resilience4j"/>
  <img src="https://img.shields.io/badge/Media%20Storage-Cloudinary-3448C5?style=flat-square&logo=cloudinary&logoColor=white" alt="Cloudinary"/>
  <img src="https://img.shields.io/badge/NLP-Komoran%203.0%20%2B%20KNU%20감성사전-8B5CF6?style=flat-square" alt="Komoran"/>
  <img src="https://img.shields.io/badge/VCS-Git%20%2B%20GitHub-181717?style=flat-square&logo=github&logoColor=white" alt="GitHub"/>
</p>
...
```mermaid
flowchart TD
    subgraph Client ["Frontend (JSP / Vanilla JS)"]
        UI_User["일반 사용자 View"]
        UI_Biz["사업자 대시보드"]
        UI_Admin["관리자 심사 View"]
    end

    subgraph Server ["Spring Boot Application Server"]
        Ctrl["Controller Layer (Flow Control)"]
        
        subgraph Services ["Service Layer"]
            TourSvc["Tour & Batch Service"]
            AuthSvc["Auth & Security Service"]
            ResvSvc["Reservation & Payment Service"]
            PostSvc["Community & NLP Service"]
        end
        
        subgraph BatchEngine ["Batch Pipeline Engine"]
            RateLimiter["Resilience4j RateLimiter\n+ Jitter Backoff (0.35s~0.5s)"]
            QueueEngine["3-Stage Queue Selecting\n& Incremental Sync Engine"]
        end

        subgraph NLP_Engine ["NLP Engine"]
            Komoran["Komoran 형태소 분석기"]
            KNU_Dict["KNU 한국어 감성사전"]
        end
    end

    subgraph External ["External Services & Open API"]
        TourAPI["한국관광공사 TourAPI 2.0"]
        KakaoPay["카카오페이 API"]
        TossPay["토스페이먼츠 API"]
    ...
    UI_User & UI_Biz & UI_Admin --> Ctrl
    Ctrl --> Services
    
    TourSvc --> BatchEngine
    BatchEngine --> RateLimiter --> TourAPI
    
    ResvSvc --> KakaoPay & TossPay
    PostSvc --> Cloudinary
    PostSvc --> Komoran & KNU_Dict
